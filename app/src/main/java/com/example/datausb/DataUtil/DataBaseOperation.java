...
public class DataBaseOperation {
   ...
   private DataBaseOperation(){}
    ...
    public void insert(SQLiteDatabase db, float currrenttemp, float[] tuebdata, String tablename) {
        //实例化常量值
    ...
    public float[] getFromDataBase(String tablename) {
        ...
        cursor.moveToFirst();
        float currenttem = cursor.getFloat(1);//得到第一行的第二个数据
    ...
    //更新数据库中的数据
    public void updataDataBase(float currenttemp, float[] tubedata, String tablenaem) {
